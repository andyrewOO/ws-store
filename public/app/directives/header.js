            ...
            return {
                link: function(scope, element) {
                    ...
                    var listener = function(event, toState) {
                        ...
                        //应用动态配置的标题
                    	if ($rootScope.$stateParams.title != undefined){
                        	toState.ncyBreadcrumb.label = $rootScope.$stateParams.title;
                    	}
            ...
            return {
                link: function (scope, element) {
                    ...
                    var listener = function (event, toState) {
                    	...
                    	if ($rootScope.$stateParams.desc != undefined){
                        	toState.ncyBreadcrumb.description = $rootScope.$stateParams.desc;
                    	}
                        if (toState.ncyBreadcrumb && toState.ncyBreadcrumb.label) title = toState.ncyBreadcrumb.label;
