//Sidebar Collapse
angular.module('app').directive('sidebarCollapse', function() {
	return {
		restrict : 'AC',
			...
			el.on('click', function() {
				...
				if (isCompact) {
					...
					if ($('.page-sidebar').hasClass('sidebar-fixed')) {
						var position = (location.pathname == "/index-rtl-fa.html" || location.pathname == "/index-rtl-ar.html") ? 'right' : 'left';
						$('.sidebar-menu').slimscroll({
...
// Setting
angular.module('app').directive('setting', function() {
	return {
		restrict : 'AC',
